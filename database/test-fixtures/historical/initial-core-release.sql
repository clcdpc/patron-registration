/*
   Immutable fixture for the schema emitted by migrations 001, before the
   operational-branch, expanded-audit, asset, and revision releases.
   Data-only migrations 006-009 do not change this DDL shape.
*/
